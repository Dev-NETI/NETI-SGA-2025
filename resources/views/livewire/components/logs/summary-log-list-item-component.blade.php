<tr class="border-b border-gray-200 dark:border-gray-700">
    <x-td>
        <p class="font-bold">Reference #: {{ $summary->reference_number }}</p>
        <p class="font-bold text-xs">{{ $summary->company->name }}</p>
        <p class="font-bold text-xs">For month: {{ $summary->formatted_month }}</p>
        {!! $summary->audit_log !!}
    </x-td>
    <td class="flex flex-row justify-center">

        <x-action-dropdown :id="$summary->id" class="mt-8">
