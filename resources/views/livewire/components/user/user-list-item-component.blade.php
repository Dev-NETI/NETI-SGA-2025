<tr class="border-b border-gray-200 dark:border-gray-700">
    <livewire:components.reusable.td label="{{ $user->full_name }}" />
    <livewire:components.reusable.td label="{{ $user->email }}" />
    <td class="px-6 py-4">
        ...
        <div id="dropdown{{ $user->id }}"
            ...
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                ...
                <li>
                    <a href="{{ route('users.edit-password', ['hash_id' => $user->hash, 'pw_id' => 1]) }}" wire:navigate
