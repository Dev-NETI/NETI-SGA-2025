<button type="button" wire:click="create('{{$routeName}}')"
    class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br 
                ...
                dark:shadow-cyan-800/80 font-medium rounded-lg text-sm px-5 py-2.5 hover:px-3 hover:py-2 text-center me-2 mb-2">
    {{ $label }}
</button>
