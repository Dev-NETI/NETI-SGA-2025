        ...
        <tr>
            <td class="v-container-padding-padding"
                ...
                <div style="font-size: 14px; line-height: 170%; text-align: left; word-wrap: break-word;">
                    ...
                    <p style="font-size: 14px; line-height: 170%;"><span
                            style="font-family: Lato, sans-serif; font-size: 16px; line-height: 27.2px;">This is to inform you that a new F-FC-007 report has been generated and is now available for your review. The report is referenced under {{ $referenceNumber }}.</span></p>
                    <p style="font-size: 14px; line-height: 170%;"> </p>
                    <p style="font-size: 14px; line-height: 170%;"><span
