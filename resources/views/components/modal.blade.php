...
<div id="crypto-modal" tabindex="-1" aria-hidden="true" {{ $attributes }}
    ...
    <div class="relative p-4 w-full max-w-md max-h-full ">
        <!-- Modal content -->
        <div class="relative bg-sgaBlue rounded-lg shadow dark:bg-gray-700 border-2 border-sgaFontBlue">
            <!-- Modal header -->
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                <h3 class="text-3xl font-semibold text-sgaFontBlue dark:text-white">
                    {{ $title }}
                </h3>
            </div>
            <!-- Modal body -->
