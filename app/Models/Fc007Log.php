...
class Fc007Log extends Model
{
    ...
    public function getAuditLogAttribute()
    {
        switch ($this->status_id) {
            case 2:
                $auditLog = '<p class="text-xs mt-1 font-semi">Generated By: ' . $this->generated_by . '</p>
                             <p class="text-xs mt-1 font-semi">Generated At: ' . $this->created_at . '</p>';
                break;
            case 3:
                $auditLog = '<p class="text-xs mt-1 font-semi">Generated By: ' . $this->generated_by . '</p>
                             <p class="text-xs mt-1 font-semi">Generated At: ' . $this->created_at . '</p>
                             <p class="text-xs mt-1 font-semi">Verified By: ' . $this->verified_by . '</p>
                             <p class="text-xs mt-1 font-semi">Verified At: ' . $this->verified_at . '</p>';
                break;
            case 4:
                $auditLog = '<p class="text-xs mt-1 font-semi">Generated By: ' . $this->generated_by . '</p>
                             <p class="text-xs mt-1 font-semi">Generated At: ' . $this->created_at . '</p>
                             <p class="text-xs mt-1 font-semi">Verified By: ' . $this->verified_by . '</p>
                             <p class="text-xs mt-1 font-semi">Verified At: ' . $this->verified_at . '</p>
                             <p class="text-xs mt-1 font-semi">Approved By: ' . $this->approved_by . '</p>
                             <p class="text-xs mt-1 font-semi">Approved At: ' . $this->approved_at . '</p>';
                break;
            default:
                $auditLog = "";
                break;
